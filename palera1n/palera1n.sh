...
echo "palera1n | Version (a working one lol)"
...
#        exit -1
#    }
    osascript -e 'tell app "System Events" to display dialog "Please enter DFU mode! Once the device is in DFU mode, press Ok."'
fi
sleep 2
